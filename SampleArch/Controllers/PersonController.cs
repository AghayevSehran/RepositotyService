...
namespace SampleArch.Controllers
{
    public class PersonController : Controller
    {
        ...
        {
            var lstModelPerson = new List<Models.Person>();
            Mapper.Map(_PersonService.GetAll(), lstModelPerson);
            return View(lstModelPerson);
        }
        ...
        public ActionResult Details(long? id)
        {
            ...
            var lstModelPerson = new Models.Person();
            Mapper.Map(person, lstModelPerson);
            return View(lstModelPerson);
        }
